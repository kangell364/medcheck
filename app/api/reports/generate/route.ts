...
function buildEmailHTML(params: {
  ...
  const globalPct = globalScheduled > 0 ? Math.round((globalTaken / globalScheduled) * 100) : 0
              ...
              <tr>
                <td style="padding: 20px 24px 16px 24px;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 16px;">
                    <tr>
                      <td style="width: 33%; text-align: center; background: white; border-radius: 8px; padding: 12px 8px;">
                        <span style="display: block; font-size: 22px; font-weight: 800; color: ${pctColor};">${pct}%</span>
                        <span style="display: block; font-size: 10px; color: #6b7280; font-weight: 500;">Adherence</span>
                      </td>
                      <td style="width: 4px;"></td>
                      <td style="width: 33%; text-align: center; background: white; border-radius: 8px; padding: 12px 8px;">
                        <span style="display: block; font-size: 22px; font-weight: 800; color: #065f46;">${taken}</span>
                        <span style="display: block; font-size: 10px; color: #6b7280; font-weight: 500;">Taken</span>
                      </td>
                      <td style="width: 4px;"></td>
                      <td style="width: 33%; text-align: center; background: white; border-radius: 8px; padding: 12px 8px;">
                        <span style="display: block; font-size: 22px; font-weight: 800; color: #dc2626;">${missed}</span>
                          ...
                          <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                              <td style="padding-bottom: 10px;">
                                <p style="margin: 0; font-size: 12px; color: #6b7280; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Scheduled</p>
                                <p style="margin: 2px 0 0 0; font-size: 20px; font-weight: 800; color: #111827;">${globalScheduled}</p>
                              </td>
                              <td style="padding-bottom: 10px;">
                                <p style="margin: 0; font-size: 12px; color: #059669; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Taken</p>
                                <p style="margin: 2px 0 0 0; font-size: 20px; font-weight: 800; color: #059669;">${globalTaken}</p>
                              </td>
                              <td style="padding-bottom: 10px;">
                                <p style="margin: 0; font-size: 12px; color: #dc2626; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Missed</p>
                                <p style="margin: 2px 0 0 0; font-size: 20px; font-weight: 800; color: #dc2626;">${globalMissed}</p>
                              </td>
                            </tr>
                          </table>
                          <p style="margin: 8px 0 0 0; font-size: 11px; color: #6b7280; line-height: 1.5;">
                            ${globalScheduled - globalTaken - globalMissed > 0 ? `(${globalScheduled - globalTaken - globalMissed} with no data)` : ''}
                          </p>
                        </td>
                      </tr>
                    </table>
