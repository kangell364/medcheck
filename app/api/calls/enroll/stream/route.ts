...
export async function GET(_request: NextRequest): Promise<NextResponse> {
  // Signal that this endpoint requires a WebSocket upgrade.
  // The custom server (server.ts) intercepts WebSocket upgrade requests
  // before they reach Next.js and handles them directly.
