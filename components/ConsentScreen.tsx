...
export default function ConsentScreen({ patientId, token, firstName, caregiverName }: Props) {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // Refresh the page — server will now see terms_accepted_at and show meds
      router.refresh()
    } catch (err) {
